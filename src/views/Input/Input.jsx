...
class Input extends React.Component {
  handleOnclick(e) {
    if (e.keyCode === 13 && e.target.value.trim() !== '') {
      ...
      this.props.changeInpting('');
    }
  }
  
  changeInput(e) {
    this.props.changeInpting(e.target.value);
  }
  ...
  render() {
    return (
      <div className="toggle">
        <span className="toggle-all" onClick={this.toogleClick.bind(this)}>></span>
...
export default connect (
  ...
  dispatch => ({
    changeInpting: bindActionCreators(changeInputingAction,dispatch),
